...
// =====================================================================================================================
func CreateServiceAgentRelation(relationId string, serviceId string, agentId string, cost string, time string, description string,  stub shim.ChaincodeStubInterface) (*ServiceRelationAgent, error) {
	// ==== Create marble object and marshal to JSON ====
	serviceRelationAgent := &ServiceRelationAgent{relationId, serviceId, agentId, cost, time, description}
...
// 3. INDEXING
// =====================================================================================================================
func CheckingCreatingIndexingServiceRelationAgent(serviceId string, agentId string, cost string, time string, description string, stub shim.ChaincodeStubInterface) (*ServiceRelationAgent, error){
	...
	serviceRelationAgent, err := CreateServiceAgentRelation(relationId, serviceId, agentId, cost, time, description, stub)
	if err != nil {
...
// =====================================================================================================================
// UpdateServiceRelationAgentCost - Modify the serviceRelationAgent cost of the asset passed as parameter
// =====================================================================================================================
func UpdateServiceRelationAgentCost(serviceRelationAgent ServiceRelationAgent, newRelationCost string, stub shim.ChaincodeStubInterface) (error) {
...
// =====================================================================================================================
// UpdateServiceRelationAgentTime - Modify the serviceRelationAgent time of the asset passed as parameter
// =====================================================================================================================
func UpdateServiceRelationAgentTime(serviceRelationAgent ServiceRelationAgent, newRelationTime string, stub shim.ChaincodeStubInterface) (error) {
...
// =====================================================================================================================
// UpdateServiceRelationAgentDescription - Modify the serviceRelationAgent description of the asset passed as parameter
// =====================================================================================================================
func UpdateServiceRelationAgentDescription(serviceRelationAgent ServiceRelationAgent, newRelationTime string, stub shim.ChaincodeStubInterface) (error) {

	serviceRelationAgent.Description = newRelationTime
