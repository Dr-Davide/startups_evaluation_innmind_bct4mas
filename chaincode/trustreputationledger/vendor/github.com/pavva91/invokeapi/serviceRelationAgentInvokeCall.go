...
// ========================================================================================================================
// Init Service Relation Agent  - wrapper of CreateServiceRelationAgentAndReputation called from chiancode's Invoke
// ========================================================================================================================
func CreateServiceRelationAgent(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	//   0               1       2       3       4
	// "ServiceId", "AgentId", "Cost", "Time", "Description"
	...
	serviceRelationAgent, serviceRelationError := a.CheckingCreatingIndexingServiceRelationAgent(serviceId,agentId, cost, time, description, stub)
...
// ========================================================================================================================
// Init Service Agent Relation - wrapper of CreateServiceRelationAgentAndReputation called from chiancode's Invoke
// ========================================================================================================================
func CreateServiceRelationAgentAndReputation(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	//   0               1       2       3        4
	// "ServiceId", "AgentId", "Cost", "Time", "Description"
...
// ========================================================================================================================
// Modify Service Relation Agent Cost - wrapper of UpdateServiceRelationAgentCost called from chiancode's Invoke
// ========================================================================================================================
func UpdateServiceRelationAgentCost(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	//   0            1
	...
	modifyError := a.UpdateServiceRelationAgentCost(serviceRelationAgent, newRelationCost, stub)
	if modifyError != nil {
	...
	payloadAsBytes := []byte(eventPayload)
	eventError := stub.SetEvent("ServiceRelationAgentCostUpdatedEvent",payloadAsBytes)
	if eventError != nil {
		serviceRelationAgentInvokeCallLog.Info("Error in event Creation: " + eventError.Error())
	}else {
...
// ========================================================================================================================
// Modify Service Relation Agent Time - wrapper of UpdateServiceRelationAgentTime called from chiancode's Invoke
// ========================================================================================================================
func UpdateServiceRelationAgentTime(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	//   0            1
	...
	// ==== modify the serviceRelationAgent ====
	modifyError := a.UpdateServiceRelationAgentTime(serviceRelationAgent, newRelationTime, stub)
	if modifyError != nil {
	...
	payloadAsBytes := []byte(eventPayload)
	eventError := stub.SetEvent("ServiceRelationAgentTimeUpdatedEvent",payloadAsBytes)
	if eventError != nil {
		serviceRelationAgentInvokeCallLog.Info("Error in event Creation: " + eventError.Error())
	}else {
...
// ========================================================================================================================
// Update Service Relation Agent Description - wrapper of UpdateServiceRelationAgentDescription called from chiancode's Invoke
// ========================================================================================================================
func UpdateServiceRelationAgentDescription(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	//   0            1
	...
	// ==== modify the serviceRelationAgent ====
	modifyError := a.UpdateServiceRelationAgentDescription(serviceRelationAgent, newRelationDescription, stub)
	if modifyError != nil {
		serviceRelationAgentInvokeCallLog.Info(modifyError.Error())
		return shim.Error(modifyError.Error())
	}
	...
	eventPayload:="Modified Service RelationAgent: " + serviceRelationAgent.ServiceId + " with agent: " + serviceRelationAgent.AgentId + "from old time value: " + serviceRelationAgent.Time + "to new time value: " + newRelationDescription
	payloadAsBytes := []byte(eventPayload)
	eventError := stub.SetEvent("ServiceRelationAgentDescriptionUpdatedEvent",payloadAsBytes)
	if eventError != nil {
		serviceRelationAgentInvokeCallLog.Info("Error in event Creation: " + eventError.Error())
	}else {
		serviceRelationAgentInvokeCallLog.Info("Event Modifiy ServiceRelationAgent Time OK")
