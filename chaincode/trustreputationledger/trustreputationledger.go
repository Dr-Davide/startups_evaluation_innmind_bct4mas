...
const(
	...
	CreateServiceRelationAgent                            = "CreateServiceRelationAgent"
	CreateServiceRelationAgentAndReputation               = "CreateServiceRelationAgentAndReputation"
	CreateServiceAndServiceRelationAgentWithStandardValue = "CreateServiceAndServiceRelationAgentWithStandardValue"
	CreateServiceAndServiceRelationAgent                  = "CreateServiceAndServiceRelationAgent"
	...
	UpdateServiceRelationAgentCost           = "UpdateServiceRelationAgentCost"
	UpdateServiceRelationAgentTime           = "UpdateServiceRelationAgentTime"
	UpdateServiceRelationAgentDescription    = "UpdateServiceRelationAgentDescription"
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	case CreateServiceRelationAgent:
		...
		return in.CreateServiceRelationAgent(stub, args)
	case CreateServiceRelationAgentAndReputation:
		// Already with reference integrity controls (service already exist, agent already exist, relation don't already exist)
		// Standard reputation value (6) from inside
		return in.CreateServiceRelationAgentAndReputation(stub, args)
	case CreateServiceAndServiceRelationAgentWithStandardValue:
	...
	case CreateServiceAndServiceRelationAgent:
	...
	case DeleteServiceRelationAgent:
		...
		// UPDATE:
	case UpdateServiceRelationAgentCost:
		return in.UpdateServiceRelationAgentCost(stub,args)
	case UpdateServiceRelationAgentTime:
		return in.UpdateServiceRelationAgentTime(stub,args)
	case UpdateServiceRelationAgentDescription:
		return in.UpdateServiceRelationAgentDescription(stub,args)
