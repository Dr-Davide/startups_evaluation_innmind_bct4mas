...
//    might not be ideal, it is unavoidable because aclMessage) the signature needs to also
...
//    Header is both the header of a Proposal and of a Transaction, in that aclMessage)
