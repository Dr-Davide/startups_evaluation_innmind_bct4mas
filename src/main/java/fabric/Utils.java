...
public class Utils {
  ...
  public static void serialize(UserImplementation fabricUser) throws IOException {
    ...
    // in SOURCE: /home/anakin/Documents/Valerio/github.com/startups_evaluation_innmind_bct4mas OK(vogliamo andare qua, trovare il modo elegante di farlo)
    // in JAR: /home/anakin/Documents/Valerio/github.com/startups_evaluation_innmind_bct4mas/target FIX
    ...
    //    if (workingDir.equals("/home/anakin/Documents/Valerio/github.com/startups_evaluation_innmind_bct4mas")) {
    if (pathParts[pathParts.length - 1].equals("target")) {
      ...
      //          "/home/anakin/Documents/Valerio/github.com/startups_evaluation_innmind_bct4mas/" + certFolderPath
      //              + fabricUser.getName());
    ...
    } else if (pathParts[pathParts.length - 1].equals("startups_evaluation_innmind_bct4mas")) {
      log.debug("OK");
