...
public class DenyFeatureExecution extends OneShotBehaviour {

  private static final Logger log = Logger.getLogger(DenyFeatureExecution.class);
  ...
  public DenyFeatureExecution(BCAgent agent, String serviceId, String demanderAgentId) {
    super(agent);
    bcAgent = agent;
  ...
  public DenyFeatureExecution(BCAgent agent) {
    super(agent);
    bcAgent = agent;
  }
  ...
  public void action() {
    ...
    sendDenyFeatureExecutionMessage(serviceId, demanderAgentId, bcAgent.getMyName());
   ...
   * @param myName
   */
  private void sendDenyFeatureExecutionMessage(String serviceId, String demanderAgentId,
      String myName) {
