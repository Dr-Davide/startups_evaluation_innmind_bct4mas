...
public class AddLeafFeatureStartupPanel extends JPanel {


    private JButton buttonAddFeature;
    private CouplePanel panelFeatureName = new CouplePanel("Name:  ");
    private final JLabel lblAddFeature = new JLabel("Add Leaf Feature");

    /**
     * Create the panel.
     */
    public AddLeafFeatureStartupPanel() {
...
//        add(panelFeatureTime, gbc_panelFeatureTime);
        ...
        buttonAddFeature = new JButton("Add Leaf Feature");
