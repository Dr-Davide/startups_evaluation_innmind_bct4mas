...
public class ServiceAgentInformationPanel extends JPanel {
  ...
  ServiceAgentInformationPanel() {
    ...
    serviceDescriptionLabel = new JLabel("Service Description");
   ...
   */
  public JLabel getServiceDescriptionLabel() {
   ...
   */
  public void setServiceDescriptionLabel(JLabel serviceDescriptionLabel) {
